...
public class logo : MonoBehaviour {
	...
	void loadScene()
	{
		...
		int fallbackIndex = activeIndex + 1;
		...
		{
			Debug.LogError($"AAU splash could not load next scene. Configured nextSceneName='{nextSceneName}', fallbackIndex={fallbackIndex}, sceneCount={SceneManager.sceneCountInBuildSettings}.");
		}
	}
}
